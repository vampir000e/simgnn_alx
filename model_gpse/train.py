...
class Trainer(object):
    ...
    # 批量预测
    def batch_pairs_predication(self, batch_feature_1, batch_adjacent_1, batch_mask_1, batch_feature_2,
    ...
    def training_batch_predication(self, batch_feature_1, batch_adjacent_1, batch_mask_1, batch_feature_2,
        ...
        self.model.train()
        self.optimizer.zero_grad() # 梯度清零，进行反向传播和参数
    ...
    def val_batch_predication(self, batch_feature_1, batch_adjacent_1, batch_mask_1, batch_feature_2, batch_adjacent_2,
        ...
        return loss.data.item(), np.stack((trues.cpu().detach().numpy(), predictions.cpu().detach().numpy()),
                                          1), datetime.now() - st_time
        ...
        for iteration in range(self.max_iterations):
            ...
            if self._need_val(iteration=iteration):
                ...
                if not best_val_loss or val_loss <= best_val_loss:
                    write_log_file(self.log_file,
                                   '\tvalidation mse decreased ( {} ---> {} (e-3) ) '.format(
    ...
    def testing(self):
        ...
        ps, inclusive_true_ks, inclusive_pred_ks = computing_precision_ks(trues=self.dataset.ground_truth,
                                                                          predictions=test_predictions, ks=[10],
