...
class GEDDataset(object):
    def __init__(self, ged_main_dir, args):
        ...
        # + args.datasets
        data = model_utils.SiameseDataSet(data_save_folder=self.ged_main_dir + "/PTC", data_set_name=args.dataset,
        ...
        distance = model_utils.DistanceCalculator(root_folder=self.ged_main_dir + "/PTC", data_name=data.data_set_name)
